(function($) {
    ...
    */
    ...
    // add layer
    var bikeTrailsUrl="http://localhost/bosOpenSpace-recreationActivity-map/_geoJson/bikeTrails.geojson";var bikeTrails=new L.GeoJSON.AJAX(bikeTrailsUrl,{onEachFeature:$bikeTrailsOnEachFeature,style:$bikeTrailsStyle});
    /*!
    ...
    */
    $('#Bos_nbhdSelect').on('change', function(evt, params) {    
        ...
        var recreationalActivitiesUrl = 'http://localhost/bosOpenSpace-recreationActivity-map/_geoJson/recreationalActivities.geojson';
        // clear layers
