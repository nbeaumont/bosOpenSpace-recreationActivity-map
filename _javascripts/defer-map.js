(function($) {
    ...
    */
    ...
    // add layer
    var bikeTrailsUrl="https://rawgit.com/nbeaumont/bosOpenSpace-recreationActivity-map/master/_geoJson/bikeTrails.geojson";var bikeTrails=new L.GeoJSON.AJAX(bikeTrailsUrl,{onEachFeature:$bikeTrailsOnEachFeature,style:$bikeTrailsStyle});
    /*!
    ...
    */
    $('#Bos_nbhdSelect').on('change', function(evt, params) {    
        ...
        var recreationalActivitiesUrl = 'https://rawgit.com/nbeaumont/bosOpenSpace-recreationActivity-map/master/_geoJson/recreationalActivities.geojson';
        // clear layers
