(function($) {
    ...
    */
    ...
    // add layer
    var bikeTrailsUrl="http://htmlpreview.github.io/?http://rawgit.com/nbeaumont/bosOpenSpace-recreationActivity-map/master/_geoJson/bikeTrails.geojson";var bikeTrails=new L.GeoJSON.AJAX(bikeTrailsUrl,{onEachFeature:$bikeTrailsOnEachFeature,style:$bikeTrailsStyle});
    /*!
    ...
    */
    ...
    // add layer
    var farmersMarketsUrl="http://htmlpreview.github.io/?http://rawgit.com/nbeaumont/bosOpenSpace-recreationActivity-map/master/_geoJson/farmersMarkets.geojson";var farmersMarkets=new L.GeoJSON.AJAX(farmersMarketsUrl,{onEachFeature:$farmersMarketsOnEachFeature,pointToLayer:$farmersMarketsPointToLayer});
    /*!
    *		Control Layer
    *		=============
    *		=============
    ...
    */
    $('#Bos_nbhdSelect').on('change', function(evt, params) {    
        ...
        var recreationalActivitiesUrl = 'http://htmlpreview.github.io/?http://rawgit.com/nbeaumont/bosOpenSpace-recreationActivity-map/master/_geoJson/recreationalActivities.geojson';
        // clear layers
