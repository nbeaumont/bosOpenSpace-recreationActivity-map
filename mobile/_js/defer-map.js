...
var activitiesMarkersCounter=0;var nbhdOnOpen=[];var nbhdOnClose=[];
$("#Bos_nbhdSelect").multipleSelect({placeholder:"Select one or more neighborhoods...",width:"100%",filter:false,selectAllText:"Select all neighborhoods",allSelected:"All neighborhoods selected",countSelected:"# of % neighborhoods selected",onOpen:function(){
  
/*! calculate height of multipleselect dropdown menu to fit page height */   
var totalHeightValue = $("#bosOpenSpaceMap").height();
    var heightValue = totalHeightValue - 130;
$("#Bos_nbhdForm ul").css("max-height", heightValue + 'px');
...
/*! calculate height of multipleselect dropdown menu to fit page height */   
var totalHeightValue = $("#bosOpenSpaceMap").height();
    var heightValue = totalHeightValue - 188;
...
/*! calculate height of multipleselect dropdown menu to fit page height */   
var totalHeightValue = $("#bosOpenSpaceMap").height();
    var heightValue = totalHeightValue - 214;
