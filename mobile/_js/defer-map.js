...
/*! Mapzen Geocoder Toggle */
var myGeocoderOptions={};var myGeocoder=L.control.geocoder("search-tJsX16D",myGeocoderOptions);myGeocoder.on("expand",function(){$(".leaflet-pelias-control").removeClass("noTransition");if($("#searchIcon").hasClass("fa-times")){$("#searchIcon").addClass("fa-bars").removeClass("fa-times");$(".selectorsWrapper").toggle()}});
/*! Custom Selectors Toggle */
$(document).ready(function() {
    var a = $(".selectorsWrapper");
    a.hide();
    $(".searchIconWrapper").click(function(b) {
        a.slideToggle(100);
        b.preventDefault()
    });
    $("#searchIcon").addClass("fa-bars").removeClass("fa-times")
});
$(".searchIconWrapper").on("click", function(b) {
    var c = $(".leaflet-pelias-control");
    $("#searchIcon").toggleClass("fa-bars fa-times");
    b.preventDefault();
    if (c.hasClass("leaflet-pelias-expanded")) {
...
function $activitiesOnEachFeature(feature, layer) {
    ...
    if (feature.properties && feature.properties.Category_7) {
        $("#activitiesSelect").append($("<option>", {
            value: feature.properties.Category_7,
            text: feature.properties.Category_7
        }));
        $("#activitiesSelect option").removeDuplicate();
        $("#activitiesSelect option").sortAlpha()
    } else {}
...
onClick:function(){/*!$(".selectorsWrapper").hide(100);$("#searchIcon").addClass("fa-bars").removeClass("fa-times");*/var nbhdSelectedValues=$("#Bos_nbhdSelect").multipleSelect("getSelects");var nbhdSelectedValuesObjLenght=Object.keys(nbhdSelectedValues).length;myIndivOpenSpaceLayer.clearLayers();myActivitiesMarkerClusterGroup.clearLayers();$("#activitiesSelect").clearMenu();$("#mapOverlay").show();map.spin(true);$("#openSpaceZoomBtn").prop("disabled",false);setTimeout(function(){var openSpaceSelectedValues=$("#Bos_openSpaceSelect").multipleSelect("getSelects");var openSpaceSelectedValuesObjLenght=Object.keys(openSpaceSelectedValues).length;
